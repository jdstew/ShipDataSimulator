...
public class OwnshipController implements OwnshipSimulationListener {
    ...
    */
   public OwnshipController (AbstractShip shipObj, DebugManager dbgMgr) { 
      if (dbgMgr != null) {
         debugManager = dbgMgr;
      }
      else {
      ...
      if (shipObj != null) {
         ownshipSimulator = new OwnshipSimulator(this, shipObj, debugManager);
         autopilot = new Autopilot(this, shipObj, debugManager);
      }
      else {
         AbstractShip defaultShip = new DefaultShip ();
         ownshipSimulator = new OwnshipSimulator(this, defaultShip, debugManager);
         autopilot = new Autopilot(this, defaultShip, debugManager);
         debugManager.report (DebugListener.CODE_FAULT,
            "AbstractShip object not passed to OwnshipController object. ");
      }
   ...
   /**
    * Set the ownship simulator panel (GUI) source.
    *
    * @param ownSimPanel The ownship simulation control panel.
    */   
   public void setOwnshipSimulatorPanel (OwnshipSimulatorPanel ownSimPanel) {
      if (ownSimPanel != null) {
         ownshipSimulatorPanel = ownSimPanel;
      }
   }

   /**
    * Set the autopilot control panel (GUI) source.
    *
    * @param autoCntrlPanel The autopilot control panel.
    */   
   public void setAutopilotControlPanel (AutopilotControlPanel autoCntrlPanel) {
      if (autoCntrlPanel != null) {
         autopilotControlPanel = autoCntrlPanel;
      }
   }
