...
//   double rudderAcceleration; // degrees/second
    ...
    */
   public Autopilot (OwnshipController obj, AbstractShip shipObj, DebugManager dbgMgr) {
      if (dbgMgr != null) {
         debugManager = dbgMgr;
      }
      else {
         ...
         debugManager.report (DebugListener.CODE_FAULT,
            "DebugManager object not passed to Autopilot object. ");
      }
      ...
      if (obj != null) {
         ...
         debugManager.report (DebugListener.CODE_FAULT,
            "OwnshipController object not passed to Autopilot object. ");
      }
      ...
      if (shipObj != null) {
         ...
         debugManager.report (DebugListener.CODE_FAULT,
            "AbstractShip object not passed to Autopilot object. ");
      }
