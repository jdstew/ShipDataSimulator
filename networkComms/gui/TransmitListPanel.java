...
public class TransmitListPanel extends JPanel implements TransmitListListener {
    ...
    * sentences.
    */
   public TransmitListPanel (JFrame parentFrame, MessageManager sentMngr) {
      if (parentFrame != null) {
      ...
      messageManager.addTransmitListListener (this);
   ...
   public void addSentence () {
      TransmitMessageData newMessageData = new TransmitMessageData ();     
      SetTransmitMessagePanel newTranmittingMessagePanel = new SetTransmitMessagePanel (newMessageData);
      newMessageData = newTranmittingMessagePanel.showDialog (applicationFrame);
      
      if (newMessageData != null) {
         messageManager.addTransmitMessage (newMessageData.messageID, 
                                             newMessageData.dataSource, 
                                             newMessageData.transmitPeriod);
      }
   }
   ...
   public void clearSentenceList () {
      messageManager.stopAllTransmittingMessages (); 
   }
