...
/**
 * This panel provides a container for a serial port receive list table.
 *
 * @author Jeff Stewart
...
public class ReceiveListPanel extends JPanel implements ReceiveListListener {
    ...
    */
   public ReceiveListPanel (SentenceManager sentMngr) {
      receiveTableModel = new ReceiveTableModel();
      
      sentenceManager = sentMngr;
      sentenceManager.addReceiveListListener (this);
      ...
      clearListButton.addActionListener (new
         ActionListener () {
            public void actionPerformed (ActionEvent event) {
               sentenceManager.resetReceivedSentences ();
            }
         });
