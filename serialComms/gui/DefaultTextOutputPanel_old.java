 ...
 */
public class DefaultTextOutputPanel_old extends JPanel {

	private static final long serialVersionUID = 1L;
	public static final int MAX_DISPLAY_LINES = 400;
    ...
    */
   public DefaultTextOutputPanel_old () {
      ...
      gotoEndOfTextButton.setToolTipText ("Move the non-editing cursor to the end of the text.");
